...
import (
	...
	"github.com/skupperproject/skupper/pkg/flow/eventsource"
...
func getRecordTypes() []v1.Record {
	recordTypes := []v1.Record{
		v1.SiteRecord{},
		v1.LinkRecord{},
		v1.RouterRecord{},
		v1.ListenerRecord{},
	...
	if EnableRecordsFlow {
		recordTypes = append(recordTypes, v1.FlowRecord{})
	}
	if EnableRecordsLogs {
		recordTypes = append(recordTypes, v1.LogRecord{})
	}
	return recordTypes
}

func serveRecords(ctx context.Context, factory messaging.ConnectionFactory) {
	...
	go discovery.Run(ctx, eventsource.DiscoveryHandlers{
		Discovered: func(source eventsource.Info) {
			...
			client.OnHeartbeat(func(_ v1.HeartbeatMessage) {
				flushOnce()
			})
