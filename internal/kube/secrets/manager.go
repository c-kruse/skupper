...
func NewProfilesWatcher(factory SecretsCacheFactory, client kubernetes.Interface, update UpdateRouterConfigFn, namespace string, logger *slog.Logger) *ProfilesWatcher {
