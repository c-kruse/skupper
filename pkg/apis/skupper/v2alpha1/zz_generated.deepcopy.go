...
func (in *MultiKeyListenerSpec) DeepCopyInto(out *MultiKeyListenerSpec) {
	*out = *in
	...
	if in.RoutingKeys != nil {
		...
		*out = make([]RoutingKeyOptions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RoutingKeyOptions) DeepCopyInto(out *RoutingKeyOptions) {
	*out = *in
	if in.Options != nil {
		in, out := &in.Options, &out.Options
		*out = new(runtime.RawExtension)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RoutingKeyOptions.
func (in *RoutingKeyOptions) DeepCopy() *RoutingKeyOptions {
	if in == nil {
		return nil
	}
	out := new(RoutingKeyOptions)
	in.DeepCopyInto(out)
	return out
}
