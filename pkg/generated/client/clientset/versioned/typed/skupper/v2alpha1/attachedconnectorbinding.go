...
type AttachedConnectorBindingInterface interface {
	...
	Apply(ctx context.Context, attachedConnectorBinding *applyconfigurationskupperv2alpha1.AttachedConnectorBindingApplyConfiguration, opts v1.ApplyOptions) (result *skupperv2alpha1.AttachedConnectorBinding, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, attachedConnectorBinding *applyconfigurationskupperv2alpha1.AttachedConnectorBindingApplyConfiguration, opts v1.ApplyOptions) (result *skupperv2alpha1.AttachedConnectorBinding, err error)
...
type attachedConnectorBindings struct {
	*gentype.ClientWithListAndApply[*skupperv2alpha1.AttachedConnectorBinding, *skupperv2alpha1.AttachedConnectorBindingList, *applyconfigurationskupperv2alpha1.AttachedConnectorBindingApplyConfiguration]
}
...
func newAttachedConnectorBindings(c *SkupperV2alpha1Client, namespace string) *attachedConnectorBindings {
	return &attachedConnectorBindings{
		gentype.NewClientWithListAndApply[*skupperv2alpha1.AttachedConnectorBinding, *skupperv2alpha1.AttachedConnectorBindingList, *applyconfigurationskupperv2alpha1.AttachedConnectorBindingApplyConfiguration](
