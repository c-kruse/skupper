...
type RouterAccessInterface interface {
	Create(ctx context.Context, routerAccess *skupperv2alpha1.RouterAccess, opts v1.CreateOptions) (*skupperv2alpha1.RouterAccess, error)
	Update(ctx context.Context, routerAccess *skupperv2alpha1.RouterAccess, opts v1.UpdateOptions) (*skupperv2alpha1.RouterAccess, error)
	// Add a +genclient:noStatus comment above the type to avoid generating UpdateStatus().
	UpdateStatus(ctx context.Context, routerAccess *skupperv2alpha1.RouterAccess, opts v1.UpdateOptions) (*skupperv2alpha1.RouterAccess, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*skupperv2alpha1.RouterAccess, error)
...
func newRouterAccesses(c *SkupperV2alpha1Client, namespace string) *routerAccesses {
	return &routerAccesses{
		gentype.NewClientWithList[*skupperv2alpha1.RouterAccess, *skupperv2alpha1.RouterAccessList](
			...
			namespace,
			func() *skupperv2alpha1.RouterAccess { return &skupperv2alpha1.RouterAccess{} },
			func() *skupperv2alpha1.RouterAccessList { return &skupperv2alpha1.RouterAccessList{} },
		),
	}
}
