...
func (b *EndpointApplyConfiguration) WithHost(value string) *EndpointApplyConfiguration {
	b.Host = &value
	return b
}
...
func (b *EndpointApplyConfiguration) WithGroup(value string) *EndpointApplyConfiguration {
	b.Group = &value
	return b
}
