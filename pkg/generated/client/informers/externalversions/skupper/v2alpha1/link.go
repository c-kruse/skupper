...
type LinkInformer interface {
	...
	Lister() skupperv2alpha1.LinkLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SkupperV2alpha1().Links(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().Links(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().Links(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().Links(namespace).Watch(ctx, options)
			},
		},
		&apisskupperv2alpha1.Link{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *linkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisskupperv2alpha1.Link{}, f.defaultInformer)
}

func (f *linkInformer) Lister() skupperv2alpha1.LinkLister {
	return skupperv2alpha1.NewLinkLister(f.Informer().GetIndexer())
}
