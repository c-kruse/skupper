...
type SiteInformer interface {
	...
	Lister() skupperv2alpha1.SiteLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SkupperV2alpha1().Sites(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().Sites(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().Sites(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().Sites(namespace).Watch(ctx, options)
			},
		},
		&apisskupperv2alpha1.Site{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *siteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisskupperv2alpha1.Site{}, f.defaultInformer)
}

func (f *siteInformer) Lister() skupperv2alpha1.SiteLister {
	return skupperv2alpha1.NewSiteLister(f.Informer().GetIndexer())
}
