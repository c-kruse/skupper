...
var decoderTests = []struct {
...
}{
	{
		...
		Out: &v1.RouterRecord{
			BaseRecord: v1.NewBase("routerid", time.UnixMicro(100), time.UnixMicro(1000)),
		...
		CaseName: Name(""),
		In:       func() any { var nilMap map[any]any; return nilMap }(),
		ErrorMsg: "decode error: cannot decode nil record attribute set",
	}, {
		CaseName: Name(""),
		In:       "hello",
		ErrorMsg: "decode error: cannot decode non-map type string",
	}, {
		CaseName: Name(""),
		...
		Out: &v1.RouterRecord{
			BaseRecord: v1.NewBase("routerid", time.UnixMicro(100)),
		},
		Golden: true,
	}, {
