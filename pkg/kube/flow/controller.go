...
const indexByNSName = "byNamespaceName"
...
func NewController(cfg ControllerConfig) *Controller {
	...
	pods := store.NewSyncMapStore(store.SyncMapStoreConfig{Indexers: map[string]store.Indexer{
		indexByNSName: func(e store.Entry) []string {
			var name string
