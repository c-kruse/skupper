...
func TestAnnotatedResources(t *testing.T) {
	...
	testTable := []test{
		...
		{
			name:          "services-add-extra-ports",
			doc:           "Extra service ports are added to existing services",
			modification:  annotation.AddPorts,
			expectedSites: 2,
			expectedServicesProto: map[string]string{
				"nginx-1-dep-web:8080":          "tcp",
				"nginx-2-dep-web:8080":          "tcp",
				"nginx-1-dep-web:9090":          "tcp",
				"nginx-2-dep-web:9090":          "tcp",
				"nginx-1-dep-web:8888":          "tcp",
				"nginx-2-dep-web:8888":          "tcp",
				"nginx-1-dep-web:9999":          "tcp",
				"nginx-2-dep-web:9999":          "tcp",
				"nginx-1-svc-exp-notarget:8080": "tcp",
				"nginx-2-svc-exp-notarget:8080": "tcp",
				"nginx-1-svc-exp-target:8080":   "http",
				"nginx-2-svc-exp-target:8080":   "http",
		...
		{
			name:          "services-remove-extra-ports",
			doc:           "Extra service port removed from existing services",
			modification:  annotation.RemovePorts,
			expectedSites: 2,
			expectedServicesProto: map[string]string{
				"nginx-1-dep-web:8080":          "tcp",
				"nginx-2-dep-web:8080":          "tcp",
		...
		{
			name:          "deployments-to-target-not-owned-service",
			doc:           "Change deployment target address to point to a not owned service",
			modification:  annotation.ChangeAddress,
			expectedSites: 2,
			expectedServicesProto: map[string]string{
				"nginx-1-dep-not-owned:8080":    "tcp",
				"nginx-2-dep-not-owned:8080":    "tcp",
				"nginx-1-dep-not-owned:9090":    "tcp",
				"nginx-2-dep-not-owned:9090":    "tcp",
				"nginx-1-dep-not-owned:8888":    "tcp",
				"nginx-2-dep-not-owned:8888":    "tcp",
				"nginx-1-svc-exp-notarget:8080": "tcp",
				"nginx-2-svc-exp-notarget:8080": "tcp",
				"nginx-1-svc-exp-target:8080":   "http",
				"nginx-2-svc-exp-target:8080":   "http",
		...
		{
			name:          "revert-address",
			doc:           "Revert the address and verify original service is restored",
			modification:  annotation.RevertAddress,
			expectedSites: 2,
			expectedServicesProto: map[string]string{
				"nginx-1-dep-web:8080":          "tcp",
				"nginx-2-dep-web:8080":          "tcp",
